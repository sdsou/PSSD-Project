...
*Insert image of the most important function*
...
*Insert image of the send_job function*
...
*Insert image of the email function*
...
*Insert image of the CSV results file*

2. The CSV file's information is then sent as an email to the user:

*Insert Image of the Email Sent to User*
